...
Ampliando a análise para os demais postos utilizando apenas a previsão para o ano de 2017 (L1 ~ L12). O ano das observações de interesse devem ser selecionadas por meio das funções `getl_mteste`,`meanlg` e `mprev_lt`, estas funções são responsáveis por selecionar as observações, realizar as previsões modelo de média mensal a longo prazo e do modelo PSF.
