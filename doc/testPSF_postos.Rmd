...
Iremos verificar o desempenho do modelo utilizando os parâmetros médios no conjunto de dados de testes.
...
Observamos, baseado na métrica KGE, uma pequena melhora no modelo utilizando a seleção dos parâmetros.
